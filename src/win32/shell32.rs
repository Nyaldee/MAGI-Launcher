...
//! zone de notification (tray), résolution des dossiers connus (voir
//! core::launch::known_folder).

pub use windows_sys::Win32::UI::Shell::{
    CommandLineToArgvW, ShellExecuteExW, Shell_NotifyIconW, NOTIFYICONDATAW, SHELLEXECUTEINFOW, SHQUERYRBINFO,
    SHEmptyRecycleBinW, SHQueryRecycleBinW,
    // dossiers connus (%USERPROFILE%\<...> individuellement redirigeables --
    // voir core::launch::KNOWN_FOLDERS)
    SHGetKnownFolderPath, FOLDERID_Desktop, FOLDERID_Documents, FOLDERID_Downloads, FOLDERID_Music,
